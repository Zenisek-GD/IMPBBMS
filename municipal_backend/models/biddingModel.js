...
export const Rfq = sequelize.define("Rfq", {
  ...
  procurementStartAt: { type: DataTypes.DATE, allowNull: true },
  publicationStartAt: { type: DataTypes.DATE, allowNull: true },
  publicationEndAt: { type: DataTypes.DATE, allowNull: true },
  evaluationStartAt: { type: DataTypes.DATE, allowNull: true },
  evaluationEndAt: { type: DataTypes.DATE, allowNull: true },
  postQualificationStartAt: { type: DataTypes.DATE, allowNull: true },
  postQualificationEndAt: { type: DataTypes.DATE, allowNull: true },
  expectedAwardAt: { type: DataTypes.DATE, allowNull: true },
  prebidVenue: { type: DataTypes.TEXT, allowNull: true },
  prebidRemarks: { type: DataTypes.TEXT, allowNull: true },
  scheduleApprovedAt: { type: DataTypes.DATE, allowNull: true },
  scheduleApprovedById: { type: DataTypes.INTEGER, allowNull: true },
  schedulePreparedById: { type: DataTypes.INTEGER, allowNull: true },
  schedulePublishedAt: { type: DataTypes.DATE, allowNull: true },
...
export const Evaluation = sequelize.define("Evaluation", {
  status: { type: DataTypes.ENUM("submitted", "returned", "superseded"), allowNull: false, defaultValue: "submitted" },
  failureReason: { type: DataTypes.STRING, allowNull: true },
  failureExplanation: { type: DataTypes.TEXT, allowNull: true },
  requirementRemarks: { type: DataTypes.JSON, allowNull: true },
  recommendation: { type: DataTypes.TEXT, allowNull: true },
  supportingDocuments: { type: DataTypes.JSON, allowNull: true },
  evaluationPlanId: { type: DataTypes.INTEGER, allowNull: true },
