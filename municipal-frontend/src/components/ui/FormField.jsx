...
export const fieldClass =
  'min-h-11 w-full rounded-md border border-border-muted bg-surface px-3 py-2.5 text-sm text-navy placeholder:text-text-faint transition-colors focus:border-accent focus:ring-2 focus:ring-accent/15 focus:outline-none disabled:opacity-60'
    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={`${fieldClass} ${isPassword ? 'pr-12' : ''} ${
        ...
        {isPassword && (
          <button
            ...
            className="absolute top-1/2 right-0 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-md text-text-faint transition-colors hover:text-navy focus:outline-none focus:ring-2 focus:ring-accent/20 md:h-9 md:w-9"
          >
