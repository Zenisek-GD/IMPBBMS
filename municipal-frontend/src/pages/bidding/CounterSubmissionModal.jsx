...
export default function CounterSubmissionModal({ onClose, onRecorded }) {
  ...
  return (
    // Item 12: five sections, a dozen fields and a document checklist — a long
    // workflow form on a full page, not a scroll-heavy modal.
    <LargeFormPage
      title="Record counter submission"
      purpose="Documents received in person at the BAC office. Tick what the bidder actually handed over — validity is decided afterwards, per document."
      onBack={onClose}
    ...
    >
      <LargeFormPage.Section title="Receipt">
      ...
      <LargeFormPage.Section title="Business identity">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap gap-4">
            <label className="flex min-h-[44px] items-center gap-2 text-[12.5px] text-text-secondary">
      ...
      <LargeFormPage.Section title="Official contact">
        <div className="flex flex-col gap-3">
          <FormField
      ...
      >
        ...
        <label className="mt-3 flex items-start gap-2.5 rounded border border-border-muted bg-chip p-3">
